            ...
            <div className="info_list">
                <div className="profile">
                    ...
                    <div className="profile_detail">
                        <div className="icon">
                            <div className="profile_name">{data.map((item)=>(item.name))}</div>
                            <button type="button" className="editicon"><BiEditAlt /></button>
                        </div>
                        <div className="detail">電子郵件: {data.map((item)=>(item.mail))}</div>
